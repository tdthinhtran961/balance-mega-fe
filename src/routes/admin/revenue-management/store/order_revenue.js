...
const OrderRevenue = ({ tabKey }) => {
  ...
  }, [filterDate, filterStore, filterStatus]);
  ...
  const handelTesst = async () => {
    const res = filterStore
      ? await StoreService.getListRevenueByOrderAdmin({
          ...paramSExcel,
          isExport: true,
        })
      : [];
    ...
    XLSX.utils.sheet_add_aoa(ws, [['Chọn cửa hàng:', headExcelInfo.storeName]], { origin: 'G3' });
        ...
        <div className="flex 3xl:items-center xl:items-end items-start 3xl:flex-row flex-col 3xl:gap-3">
          <div className="flex 3xl:my-0 sm:flex-row flex-col 3xl:mb-0 sm:mb-4 xl:mt-0 lg:mt-4 mt-0 w-full xl:justify-end">
            <div className="flex flex-col">
              <Select
                className="sm:w-[190px] w-full rounded-[10px] mr-0 sm:mr-6 sm:mb-0 mb-2"
  ...
  return (
    <Fragment>
      <div className="revenueByOrderStore">
        {DataRevenueByOrder()}
          ...
          return (
            <>
              ...
              <div className="w-full flex mb-5 items-center">
                <div className="font-bold order mr-2 text-base text-teal-900 sm:w-[180px]">Tổng giá trị đơn hàng: </div>
