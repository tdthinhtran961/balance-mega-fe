  ...
  return (
    <Fragment>
      <div className="min-h-screen store-wrapper">
        <p className="text-2xl font-bold text-teal-900 mb-6">Doanh thu theo đơn hàng</p>

        <div className="bg-white w-full px-4 py-6 rounded-[10px] relative revenueByOrder">
