...
const Page = () => {
  ...
  const [headExcelInfo, setHeadExcelInfo] = useState({
    ...
    dateTo: moment(firstDay).format('L'),
    status: '',
    supplierName: '',
    storeName: '',
    categoryMain: '',
  ...
  const [handleChangeDataRebvenueByOrder, DataRevenueByProduct] = HookDataTable({
    ...
    rightHeader: (
      <div className="flex 3xl:flex-row flex-col  ">
        ...
        <div className="flex 3xl:my-0 md:flex-row flex-col 3xl:mb-0 md:mb-4 w-full 3xl:mr-4 xl:justify-end justify-start mt-0">
          <div className="flex flex-col">
            <Select
              className="sm:w-[195px] w-full rounded-[10px] mr-0 sm:mr-6 md:mb-0 mb-2"
  ...
  return (
    <Fragment>
      <div className="min-h-screen store-wrapper">
        <p className="text-2xl font-bold text-teal-900 mb-6">Doanh thu theo sản phẩm</p>

        <div className="bg-white w-full px-4 py-6 rounded-[10px] relative revenueByProduct">
