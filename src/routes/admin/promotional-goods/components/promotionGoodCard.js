...
const PromotionGoodsCard = ({
  ...
  return (
    <div
      className={`card-item border border-gray-200 bg-white rounded-[10px] hover:bg-gray-100 transition-all cursor-pointer relative h-[205px] text-center`}
      onClick={() => handleChoose(item)}
    >
      <div className="flex flex-col justify-center items-center py-[10px]" style={{ height: 'fit-content' }}>
        <div className="">
          <img
